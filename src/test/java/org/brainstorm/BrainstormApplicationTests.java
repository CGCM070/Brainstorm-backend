...
//
//            voteService.votarIdea(savedIdea.getId(), created.getId(), 1);
//
...
//        transactionTemplate.executeWithoutResult(transactionStatus -> {
//            // Given - Crear sala, usuarios e idea
//            Rooms room = Rooms.builder()
//                    .title("Test Room")
//                    .createdBy("admin")
//                    .maxUsers(30)
...
//                    .build();
//            Ideas savedIdea = ideaService.createIdea(idea, user2.getUsername(), room.getId());
//
//            // Verificar estado inicial
//            assertEquals(0, savedIdea.getTotalVotes()); // Sin votos iniciales
//            assertEquals(0, savedIdea.getVotes().size());
//
//            // When - Votar la idea usando VoteService
//            Ideas votedIdea = voteService.votarIdea(savedIdea.getId(), user1.getId(), 1);
//
//            // Then - Verificar que el voto se registró
//            assertEquals(1, votedIdea.getTotalVotes()); // 0 inicial + 1 voto = 1
